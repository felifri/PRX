...
class FMPipeline(torch.nn.Module):
    """Pure PyTorch flow-matching pipeline for training and inference.

    Contains all the core flow-matching logic without any framework dependencies.
    For Composer integration, use ComposerFMPipeline which adds loss logging,
